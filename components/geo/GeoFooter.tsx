      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 py-14 md:py-18">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-800">
              <li><Link href="/cgv" className="hover:text-slate-950 transition">CGV</Link></li>
              <li><Link href="/conditions" className="hover:text-slate-950 transition">CGU</Link></li>
              <li><Link href="/confidentialite" className="hover:text-slate-950 transition">Politique de confidentialité</Link></li>
              <li><Link href="/cookies" className="hover:text-slate-950 transition">Politique cookies</Link></li>
              <li><Link href="/mentions-legales" className="hover:text-slate-950 transition">Mentions légales</Link></li>
              <li><Link href="/ia" className="hover:text-slate-950 transition">Politique IA</Link></li>
            </ul>
          </div>
        </div>
