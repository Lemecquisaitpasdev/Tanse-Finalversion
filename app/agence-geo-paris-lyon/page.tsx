      ...
      <section className="mx-auto w-full max-w-6xl px-5 md:px-6 pt-0 pb-16 md:pb-20">
        ...
        <div className="space-y-8 md:space-y-0 md:grid md:items-center md:gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-6">
            <div className="w-full max-w-[320px] h-[280px] md:max-w-full md:h-[520px] lg:h-[640px] mx-auto md:mx-0 rounded-3xl overflow-hidden md:rounded-none md:overflow-visible">
              <SplineLazy
